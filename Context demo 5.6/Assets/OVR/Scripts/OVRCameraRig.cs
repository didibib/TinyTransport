...
#region Unity Messages
	...
	private void UpdateAnchors()
	{
        ...
        if (isVR) {
            ...
            trackerAnchor.localRotation = ovrCamera.rotation;
            centerEyeAnchor.localRotation = ovrCamera.rotation;
            leftEyeAnchor.localRotation = ovrCamera.rotation;
            rightEyeAnchor.localRotation = ovrCamera.rotation;
            leftHandAnchor.localRotation = ovrCamera.rotation;
            rightHandAnchor.localRotation = ovrCamera.rotation;

            trackerAnchor.localPosition = ovrCamera.position;
            centerEyeAnchor.localPosition = ovrCamera.position;
            leftEyeAnchor.localPosition = ovrCamera.position;
            rightEyeAnchor.localPosition = ovrCamera.position;
            leftHandAnchor.localPosition = ovrCamera.position;
            rightHandAnchor.localPosition = ovrCamera.position;
        }
